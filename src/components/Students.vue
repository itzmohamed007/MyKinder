                ...
                <tbody class="divide-y divide-gray-200 bg-white">
                  <tr v-for="student in students" :key="student.email">
                    ...
                    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                      <div class="text-left text-gray-900">{{ student.age }} years</div>
                    </td>
                    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                      <span
                        class="text-left inline-flex rounded-full bg-green-100 px-2 text-xs font-semibold leading-5 text-green-800">{{ student.class }}</span>
                    </td>
                    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                      <div class="text-left text-gray-900">{{ student.teacher }}</div>
                    </td>
