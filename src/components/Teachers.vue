  ...
  <div class="px-4 sm:px-6 lg:px-8">
    <div class="sm:flex sm:items-center">
      <div class="sm:flex-auto mt-8">
        ...
        <p class="mt-2 text-sm text-gray-700">A list of all the teachers in your school including their images, names,
          emails and phone numbers.</p>
      </div>
      <div class="mt-4 sm:mt-0 sm:ml-16 sm:flex-none">
        <button type="button"
          class="inline-flex items-center justify-center rounded-md border border-transparent bg-blue-950 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-admin-hover focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 sm:w-auto">Add
          user</button>
      </div>
    </div>
            ...
            <table class="min-w-full divide-y divide-gray-300">
              ...
              <tbody class="divide-y divide-gray-200 bg-white">
                <tr v-for="person in people" :key="person.email">
                  ...
                  <td class="flex py-4 px-5 text-right text-sm font-medium sm:pr-6 justify-between align-middle">
                    <Icon icon="tabler:edit" width="25" />
                    <Icon icon="ic:round-delete-sweep" width="25" />
                  </td>
                </tr>
              </tbody>
            </table>
